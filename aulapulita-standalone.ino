/* AULAPULITA: un kit poco costoso che sia semplice da spiegare e da montare 
   che raccoglie i dati necessari ad “avvertire” quando la soglia di CO2 viene superata.
   Lista della spesa:
...
void loop () {
    ...
    if (now.month() == 25 || now.day() == 45 || now.hour() == 45 || now.minute() == 85 || now.second() == 85) {
